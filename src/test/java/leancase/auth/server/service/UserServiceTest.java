...
import leancase.auth.server.AuthServerMain;
import leancase.auth.server.service.security.ClientDetailService;
...
//       awesomeUser = podamFactory.manufacturePojo(User.class);
        ...
        awesomeUser.setEmail("sloochik89@gmail.com");
        awesomeUser.setPassword(passwordEncoder.encode("123456"));
        awesomeUser.setId("thisis-awesome-2");
